...
### 修改
- 文件：CLAUDE.md — 移除 useTheme.js/bg.png/暗色主题/主题切换按钮等已删除内容，更新组件树和数据流描述
- 文件：.claude/CLAUDE.md — 简化主题系统规则，移除暗色变量分层和图标反色说明，更新修改场景步骤
...
### 修改
- 文件：app/app.vue — 删除 --bg-image 和 bg.png 引用，背景改为纯色 #f4f5f7

### 移除
- 文件：app/assets/img/bg.png — 背景图片文件
